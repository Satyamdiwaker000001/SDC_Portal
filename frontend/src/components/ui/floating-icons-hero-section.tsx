...
const Icon = ({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="flex items-center justify-center w-16 h-16 md:w-20 md:h-20 p-3 rounded-3xl shadow-xl bg-white/80 backdrop-blur-md border border-zinc-200/50"
        animate={{
          y: [0, -8, 0, 8, 0],
          x: [0, 6, 0, -6, 0],
          rotate: [0, 5, 0, -5, 0],
      ...
      >
        <iconData.icon className="w-8 h-8 md:w-10 md:h-10 text-zinc-900" />
      </motion.div>
    </motion.div>
  );
};
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight bg-gradient-to-b from-zinc-950 to-zinc-700 text-transparent bg-clip-text">
          {title}
        </h1>
        <p className="mt-6 max-w-xl mx-auto text-lg text-zinc-600">
          {subtitle}
        </p>
        <div className="mt-10">
          <Button asChild size="lg" className="px-8 py-6 text-base font-semibold bg-zinc-900 text-white hover:bg-zinc-800 transition-colors shadow-lg">
